...
|          |            |                        | `:indeterminate`         | `input:indeterminate { background-color: red; }`       | indeterminate プロパティが true に設定されてチェックボックス、フォーム内の同じ name の値を持つすべてのラジオボタンが未選択、中間の状態のprogress要素 |
...
|          |            |                        | `:in-range`              | ※10                                                    | 選択した値が許容範囲内にある場合                                                                                                                     |
|          |            |                        | `:out-of-range`          | ※10                                                    | 選択した値が許容範囲内にない場合                                                                                                                     |
...
|          |            |                        | `:user-invalid`          | ※11                                                    | 不正確な値が入力されている要素                                                                                                                       |
|          |            |                        |                          |                                                        |                                                                                                                                                      |
|          |            | ツリー構造擬似クラス   |                          |                                                        |                                                                                                                                                      |
|          |            |                        | `:root`                  | `:root { border: 5px dashed red; }`                    | 文書のルートである要素                                                                                                                               |
|          |            |                        | `:empty`                 | `div:empty { background-color: red; }`                 | 空白文字以外に子要素・文字列がない要素                                                                                                               |
|          |            |                        | `:nth-child`             | ※12                                                    | 兄弟要素のリストから要素を選択                                                                                                                       |
|          |            |                        | `:nth-last-child`        |                                                        | 兄弟要素のリストの末尾から逆方向に要素を選択                                                                                                         |
|          |            |                        | `:first-child`           | ※12                                                    | 兄弟のうちの最初の要素                                                                                                                               |
|          |            |                        | `:last-child`            | ※12                                                    | 兄弟のうちの最後の要素                                                                                                                               |
|          |            |                        | `:only-child`            | ※12                                                    | 兄弟要素がない要素                                                                                                                                   |
|          |            |                        | `:nth-of-type`           | ※13                                                    | 兄弟要素のリストの特定の型に一致する要素                                                                                                             |
|          |            |                        | `:nth-last-of-type`      |                                                        | 兄弟要素のリストの末尾から逆方向に特定の型に一致する要素                                                                                             |
|          |            |                        | `:first-of-type`         | ※13                                                    | 兄弟のうちの最初の特定の型に一致する要素                                                                                                             |
|          |            |                        | `:last-of-type`          | ※13                                                    | 兄弟のうちの最後の特定の型に一致する要素                                                                                                             |
|          |            |                        | `:only-of-type`          | ※13                                                    | 指定された型セレクターで兄弟要素がない要素                                                                                                           |
|          |            |                        |                          |                                                        |                                                                                                                                                      |
